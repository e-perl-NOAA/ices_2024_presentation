...
## Sun-setting of ADMB
![](ADMB_logo.png){.absolute bottom=600 left=500 width="300"}
...
![](software_maintenance_transparent.png){.absolute top=140 left=570 width="550"}
...
- Ways to build a strong developer community
  ...
  - Example: [GitHub community](https://github.com/orgs/community/discussions/) :octocat:
:::
