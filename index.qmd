...
::: {.column width="47%" .nopad style="font-size:90%"}
...
::: {.column width="53%" .nopad style="font-size:90%"}
...
::: {style="color:#007582; font-size:150%; font-weight:bold;" .absolute left=375 top=525 .fragment fragment-index=1}
