...
:::{.absolute top=550 left=600 style="font-size:150%; font-weight: bold; color: #d8e8e9;"}
What I do now...
:::

::: {.notes}
We find ourselves in spaces that look more like this. While we are all scientists, we end up develop software, models, etc. because we are capable coders and we able to find ways to do it with few resources than it would to get software developers to develop it for is. This process is more organic and mostly done as time allows to meet our needs. For the most part, none of us are paid to develop scientific software.
:::
...
::: {.notes}
And for the most part, we do pretty well. We have embraced open-source tools like RStudio, Jupyter, GitHub, Docker, and more. Teaching ourselves how to code, use containers, employ version control, take advantage of cloud computing, and so much more.
:::
...
:::{.fragment fragment-index=1 .absolute top=190}
- ADMB funding ended March 2024
:::

:::{.fragment fragment-index=2 .absolute top=240}
...
:::{style="color: #007582; font-size:125%; font-weight:bold" .fragment fragment-index=4}
...
![](images/software_maintenance_transparent.png){.absolute top=160 left=500 width="560"}
...
Continuous learning and training for scientists/development teams to 
:::
...
![](images/runner.png){.absolute top=90 left=55 width="400" .fragment fragment-index=1}
![](images/down.png){.absolute top=175 left=555 width="400" .fragment fragment-index=1}
