...
::: {style="font-size: 90%"}
- I get so many emails about suggested updates and changes on repos that I maintain
- I would rather have people create and issue or make a pull request because it would cut down the time that I spend doing maintenance tasks.
- Why aren't they doing this?? Is it fear, lack of knowledge, or something else?
- I have tried contributing to other repos only to have a maintainer email me that they don't know what to do with my PR.
